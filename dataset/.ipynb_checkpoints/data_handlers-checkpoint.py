...
#     images = read_hdf5("../../autodl-fs/image_feature_{}_unnorm.h5".format(dataset.upper()), 'image_emb', normalize=True)
#     captions = read_hdf5("../../autodl-fs/caption_feature_{}_unnorm.h5".format(dataset.upper()), 'caption_emb', normalize=True)
