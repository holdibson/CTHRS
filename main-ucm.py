...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='ucm', help='Dataset: RSITMD OR RSICD OR UCM')
    ...
    parser.add_argument('--label_dim', type=int , default=21,help='RSICD:31,RSITMD:32,UCM:21')
