...
class Train(object):
    def __init__(self, config):
        ...
        if self.dataset == "rsicd":
            ...
            self.ImageMlp_scheduler = lr_scheduler.MultiStepLR(self.optimizer_ImageMlp,milestones=[10,30,50,70,90], gamma=1.1)
        ...
        if self.task == 0: # train 
            ...
            for epoch in range(self.total_epoch):
                ...
                if((epoch+1)%10==0):
                    ...
                    print('I2T: {:.3f}, T2I: {:.3f}'.format(img2text, text2img))
                    with open(mapfile, 'a+', encoding='utf-8') as f:
                         f.write("I2T:{:.3f},T2I:{:.3f} \n".format(img2text, text2img))
